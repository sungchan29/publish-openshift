...
### These are combined to form the cluster's FQDN (e.g., cloudpang.tistory.disconnected).
...
TOOLS_BASE_DIR="/root/ocp4/download/4.19.10/export/tool-binaries"
...
IDMS_OLM_CERTIFIED="/root/ocp4/download/4.19.10/export/oc-mirror/olm/certified/4.19/working-dir/cluster-resources/idms-oc-mirror.yaml"
