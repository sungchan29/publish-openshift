...
### - PID saved safely (avoids $! unbound variable)
...
### ---------------------------------------------------------------------------------
VM_INFO_LIST=(
    "thinkstation--mst01--8--16384--120--0"
    "thinkstation--mst02--8--16384--120--0"
    "thinkstation--mst03--8--16384--120--0"
...
printf "\n%-8s%-80s\n" "[SUCCESS]" "All VMs are up and running!" >&2
printf "%-8s%-80s\n" "[INFO]" "Next: Wait for OpenShift installation (~30-60 min)" >&2