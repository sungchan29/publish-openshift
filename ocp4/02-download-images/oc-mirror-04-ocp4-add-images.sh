...
printf "%-8s%-80s\n" "[INFO]" "=== Processing: Additional Images ==="
for image in "${ADDITIONAL_TOOLS_IMAGES[@]}"; do
    ### Skip if the element is empty (safety check)
    [[ -z "$image" ]] && continue
