...
### New images can be easily added to this list.
ADDITIONAL_TOOLS_IMAGES=(
    ...
    # "registry.example.com/another-tool:v1.0"  <-- 추가 예시
)
...
REDHAT_OPERATORS=(
  "cluster-logging"
  "openshift-gitops-operator|openshift-gitops-operator.v1.5.2|openshift-gitops-operator.v1.5.4|openshift-gitops-operator.v1.4.2|openshift-gitops-operator.v1.14.2|openshift-gitops-operator.v1.13.5|openshift-gitops-operator.v1.15.0|openshift-gitops-operator.v1.6.6"
)
