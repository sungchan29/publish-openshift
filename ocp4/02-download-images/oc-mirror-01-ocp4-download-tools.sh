...
if [[ -n $OPENSHIFT_CLIENT_RHEL8_TAR ]]; then
    printf "%-8s%-80s\n" "[INFO]" "    OCP Client (RHEL8): $OPENSHIFT_CLIENT_DOWNLOAD_URL/$OPENSHIFT_CLIENT_RHEL8_TAR"
fi
if [[ -n $OPENSHIFT_CLIENT_RHEL9_TAR ]]; then
    printf "%-8s%-80s\n" "[INFO]" "    OCP Client (RHEL9): $OPENSHIFT_CLIENT_DOWNLOAD_URL/$OPENSHIFT_CLIENT_RHEL9_TAR"
fi
...
if [[ -n $OPENSHIFT_CLIENT_RHEL8_TAR ]]; then
    download_tool "$OPENSHIFT_CLIENT_DOWNLOAD_URL/$OPENSHIFT_CLIENT_RHEL8_TAR"
fi
if [[ -n $OPENSHIFT_CLIENT_RHEL9_TAR ]]; then
    download_tool "$OPENSHIFT_CLIENT_DOWNLOAD_URL/$OPENSHIFT_CLIENT_RHEL9_TAR"
fi
if [[ -n $OC_MIRROR_RHEL8_TAR ]]; then
