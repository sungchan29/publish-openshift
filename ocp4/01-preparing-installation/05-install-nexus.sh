...
REGISTRY_DOMAIN="registry.hub.tistory.disconnected"
...
podman run -d -p 8081:8081 -p 8443:8443 -p 5000:5000 -p 5001:5001 --name nexus \
...
firewall-cmd --permanent --add-port=8443/tcp --add-port=5000/tcp --add-port=5001/tcp --zone=public
firewall-cmd --reload