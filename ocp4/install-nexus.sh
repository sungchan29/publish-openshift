...
NEXUS_CERT="/root/sungchan-desk/ocp4/disconnected/domain_certs/nexus.cloudpang.tistory.disconnected.crt"
NEXUS_KEY="/root/sungchan-desk/ocp4/disconnected/domain_certs/nexus.cloudpang.tistory.disconnected.key"
